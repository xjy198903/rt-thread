...
const uint8_t dcd_data[] = {
	...
	0xCC, 0x04, 0x5C, 0x04,
	/* #1.1, command: write_value, address: CCM_CLOCK_ROOT4_CONTROL, value: 0x603, size: 4 */
	0x40, 0xCC, 0x02, 0x00, 0x00, 0x00, 0x06, 0x03,
	...
	/* #1.131, command: write_value, address: SEMC_BR0, value: 0x80000019, size: 4 */
	0x40, 0x0D, 0x40, 0x10, 0x80, 0x00, 0x00, 0x19,
	/* #1.132, command: write_value, address: SEMC_SDRAMCR0, value: 0xFB2, size: 4 */
	0x40, 0x0D, 0x40, 0x40, 0x00, 0x00, 0x0F, 0xB6,
